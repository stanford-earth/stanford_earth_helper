...
8.x-1.10
-------------------------------------------------------------------------------_
_Release Date: 2023-06-28

- Update news footers with new magazine subscription text.
...
- Updates to contact footer for SDSS launch.
...
- Additional fix to check node type on pre-save.

8.x-1.3
-------------------------------------------------------------------------------_
_Release Date: 2022-02-10

- Additional fixes to Localist event importer.
...
8.x-1.0-alpha48
-------------------------------------------------------------------------------_
_Release Date: 2021-09-01

_EARTH-1562 Update to Earth Matters footer module.
