...
namespace Drupal\stanford_earth_events\Plugin\migrate\source;
...
// plugin for the next possible row.
    while (!isset($this->currentRow) && $this->getIterator()->valid()) {
      ...
      $curUrl = null;
      if (get_class($plugin) === 'Drupal\stanford_earth_events\Plugin\migrate_plus\data_parser\EarthSimpleXml') {
